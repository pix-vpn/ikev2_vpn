        ...
        try {
            ...
            if (alias != null) {
                ...
                if (caStr != null){
                    try {
                        CertificateFactory cf = CertificateFactory.getInstance("X.509");
                        byte[] bytes = Base64.decode(caStr.replace("-----BEGIN CERTIFICATE-----\n", "")
                                .replace("-----END CERTIFICATE-----", ""), Base64.DEFAULT);
